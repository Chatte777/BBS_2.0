...
<jsp:setProperty name="mountainReply" property="replyNo"/>
	...
	<%
		...
		if (userID == null) {
			...
			if(mountainReply.getReplyContent()==null){
				...
				int result = mountainReplyDAO.update(mountainMaster.getMountainNo(), mountainReply.getReplyNo(), mountainReply.getReplyContent());
